...
for i = 1:nlambda
    ...
    ylabel('intensity');
    title(['History filter estimator - iteration = :'  num2str(i)]);
    drawnow;
    hold off;
    hold on;
    subplot(1,2,2);
...
bestParams_GLM_Full(stimulusFilterParamsSize + 2) = -10;
...
result_GLM_Full.spikeHistoryFilter(50:end) = 0;

...
%        glmPartialParams(i).neuronIndex = learnedParameters(i).neuronNumber;
    ...
    for j = 1:numOfRepeats
        ...
        %response_GLM_Partial = RunSimulation(numOfNeurons, scaledRepStimulus, glmPartialParams, stimulusFilterSizeForSimulation, baseVectorLength, deltaT , 1);
        ...
        for i = 1:numOfNeurons
            ...
            %NeuronParameters(i).GLMPartialSimulation(j,:) =  response_GLM_Partial(i,:);
    ...
    for i = 1:numOfNeurons
        ...
        %NeuronParameters(i).GLMPartialISI = [];
        ...
        for j = 1:numOfRepeats
            ...
            %NeuronParameters(i).GLMPartialISI = [NeuronParameters(i).GLMPartialISI diff(find(NeuronParameters(i).GLMPartialSimulation(j,:)))];
